...
urlpatterns = [
    ...
    path("aprendiz/perfil/email-change/request/", AprendizEmailChangeRequestView.as_view(), name="aprendiz-email-change-request"),
    path("aprendiz/perfil/email-change/confirm/", AprendizEmailChangeConfirmView.as_view(), name="aprendiz-email-change-confirm"),
